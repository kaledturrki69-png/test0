...
type CandidatesListingPageProps = {
  refreshTrigger?: number;
};

export function CandidatesListingPage({
  refreshTrigger
}: CandidatesListingPageProps) {
  ...
  useEffect(() => {
    ...
    fetchAllDocuments();
  }, [session, status, searchTerm, refreshTrigger]);
    ...
    return (
      <div className='container mx-auto py-6'>
        <div className='text-center'>
          ...
          <p className='text-gray-600'>Please log in to view candidates.</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className='container mx-auto py-6'>
        <div className='text-center'>
          <h2 className='mb-4 text-2xl font-bold'>Error Loading Candidates</h2>
