...
export function CandidatesTrendCard() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const res = await fetch('/api/dashboard/candidates-trend');
  ...
  if (loading) {
    return (
      <Card className='@container/card'>
        <CardHeader>
          <CardDescription>Your Company Sourcing</CardDescription>
  ...
  return (
    <Card className='@container/card'>
      <CardHeader>
        <CardDescription>Candidates added this week</CardDescription>
